interface IIconEyeCloseProps {
  className?: string
  handleClickEyeIcon: () => void
}

const IconEyeClose = ({ className = '', handleClickEyeIcon = () => {} }: IIconEyeCloseProps) => {
  return (
    <span className={`cursor-pointer ${className}`} onClick={handleClickEyeIcon}>
